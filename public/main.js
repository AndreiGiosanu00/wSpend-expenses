    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [
                ...
                angular2_flash_messages__WEBPACK_IMPORTED_MODULE_14__["FlashMessagesService"],
...
module.exports = "<h2>dashboard works</h2>\n"
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (response) {
            if (response.success) {
                ...
                _this.flashMessages.show('You have successfully login!', { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigateByUrl('/dashboard');
            }
            else {
                _this.flashMessages.show(response.msg, { cssClass: 'alert-danger', timeout: 5000 });
...
var NavBarComponent = /** @class */ (function () {
    ...
    NavBarComponent.prototype.onLogoutClick = function () {
        ...
        this.flashMessages.show('You are logged out now.', { cssClass: 'alert-success', timeout: 3000 });
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (response) {
            if (response.success) {
                _this.flashMessages.show('You have registered successfully and you can login now', { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigateByUrl('/login');
            }
            else {
                _this.flashMessages.show('Something went wrong. We will investigate ASAP.', { cssClass: 'alert-danger', timeout: 3000 });
            }
        });
    };
    RegisterComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'cdk-register',
...
module.exports = __webpack_require__(/*! /home/andrei/Desktop/cdkpend/angular-src/src/main.ts */"./src/main.ts");
